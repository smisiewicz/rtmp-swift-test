...
@property (nonatomic) uint32_t actualBitrate;
...
SWIFT_CLASS("_TtC10HaishinKit11DisplayLink")
...
SWIFT_CLASS("_TtC10HaishinKit18DisplayLinkedQueue")
@interface DisplayLinkedQueue : NSObject
- (void)updateWithDisplayLink:(DisplayLink * _Nonnull)displayLink;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface GLHKView : NSOpenGLView
